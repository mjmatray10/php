<div class="content-container">
  <div class="row">
    ...
    <div class="col-auto">
      <?php include "view-brands-with-products-newform.php"; ?>
    </div>
  </div>
                ...
                <li class="list-group-item">
                  ...
                  <div class="d-flex justify-content-end">
                    ...
                    <form method="post" action="" class="ms-2">
                      ...
                      <button type="submit" class="btn btn-danger btn-sm d-flex align-items-center justify-content-center" style="width: 100px; height: 40px;" onclick="return confirm('Are you sure?');">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-x" viewBox="0 0 16 16">
                          <path d="M6.854 7.146a.5.5 0 1 0-.708.708L7.293 9l-1.147 1.146a.5.5 0 0 0 .708.708L8 9.707l1.146-1.147a.5.5 0 0 0-.708-.708L8 8.293z"/>
