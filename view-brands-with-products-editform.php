<button type="button" class="btn btn-primary btn-sm" style="width: 40px; height: 40px;" data-bs-toggle="modal" data-bs-target="#editCatalogModal<?php echo $product['product_id']; ?>">
