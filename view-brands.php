        ...
        ?>
            ...
            <td style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                ...
                <form method="post" action="" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <button type="submit" class="btn btn-warning btn-sm" style="width: 40px; height: 40px;">
                        <!-- Your Edit SVG Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                            <path d="M12.146 1.854a2 2 0 0 0-2.828 0L1 9.618V13h3.382l8.318-8.318a2 2 0 0 0 0-2.828z"/>
                        </svg>
                    </button>
                </form>
